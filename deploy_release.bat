...
curl -X POST -H "PRIVATE-TOKEN: %token%" -d name="windows" -d url="https://gitlab.com/ronme/appupdaterlib/-/jobs/artifacts/%tagName%/download?job=win_build" --url "https://gitlab.com/api/v4/projects/12425924/releases/%tagName%/assets/links"
curl -X POST -H "PRIVATE-TOKEN: %token%" -d name="mac" -d url="https://gitlab.com/ronme/appupdaterlib/-/jobs/artifacts/%tagName%/download?job=mac_build" --url "https://gitlab.com/api/v4/projects/12425924/releases/%tagName%/assets/links"
